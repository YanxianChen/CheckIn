...
public class AbsenseStudentAdapter extends RecyclerView.Adapter<StudentAdapter.ViewHolder> {
    ...
    public AbsenseStudentAdapter(List<Student> studentList){
